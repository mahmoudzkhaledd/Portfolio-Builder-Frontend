    ...
    <div className={style.mainContainer} id={data.id}>
      <div>
        ...
        <div className={style.detailsCont}>
          {data.leftImage && data.leftImage.link != "" && (
            <img
              aspectRation={1}
          ...
          <p className={style.header}>{data.headerTitle}</p>
          <br />
          <p className={style.subtitle}>{data.subTitle}</p>
        </div>
      </div>
      {data.rightImage.laptop ? (
        <Animation className={style.animation} />
      ) : (
        data.rightImage && (
          <img
            className={
              data.rightImage.floating
                ? `${"floatingImage"} ${style.rightImage}`
                : style.rightImage
            }
            src={data.rightImage.link}
